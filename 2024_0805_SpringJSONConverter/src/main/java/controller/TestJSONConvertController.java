...
public class TestJSONConvertController {
	...
	public List<PersonVo> person_list_to_json() {
		...
		list.add(new PersonVo("일길동", 21, "서울 관악구 신림1동"));
		list.add(new PersonVo("이길동", 22, "서울 관악구 신림2동"));
		list.add(new PersonVo("삼길동", 23, "서울 관악구 신림3동"));
		list.add(new PersonVo("사길동", 24, "서울 관악구 신림4동"));
		list.add(new PersonVo("오길동", 25, "서울 관악구 신림5동"));
	...
	public Map<String,Object> person_map_to_json() {
		...
		//System.out.println(new Date(1722822652834L));
